...
export default function LinkBox({longLink, shortLink}: LinkBoxProps) {
  ...
  return (
    <li className="group flex flex-col items-center p-6 bg-white rounded-lg odd:animate-flyinright even:animate-flyinleft md:flex-row md:justify-between md:space-x-4">
