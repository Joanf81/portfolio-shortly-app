...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="w-full max-w-2xl mx-auto bg-s md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-screen-2xl"
    >
      <div className="w-full max-w-2xl mx-auto bg-s md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-screen-2xl ">
        <div className="flex flex-col justify-center items-center lg:flex-row-reverse lg:justify-between lg:items-start lg:px-6">
          <IllustrationWorkingSvg
            viewBox="0 0 733 482"
            className="w-11/12 h-auto mt-12 lg:w-6/12 md:w-8/12 "
          />
          <div className="flex flex-col justify-center items-center max-w-screen-sm pt-4 text-center md:max-w-screen-md md:px-4 lg:justify-start lg:items-start lg:max-w-md lg:px-0 lg:text-left ">
            <h1 className="mt-20 text-5xl text-black font-bold lg:mt-24 lg:text-6xl">
            ...
            <Button xl className="mt-6 lg:py-4">
              Get Started
            </Button>
          </div>
        </div>
